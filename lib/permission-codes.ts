...
export const PERMISSIONS: PermissionDefinition[] = [
  ...
  { code: "warehouse.problems.release", label: "Снятие блокировки", hint: "Возвращать артикул в продажу после разбора. Только с комментарием, уровень начальника склада." },
  ...
  { code: "warehouse.scan", label: "Сканирование и этикетки", hint: "Стол сканирования УИН и печать этикеток.", upcoming: true },
  { code: "warehouse.supply", label: "Оформление поставок", hint: "Поставки на склады площадок, QR коробов и акты.", upcoming: true },
