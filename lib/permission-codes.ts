...
export const PERMISSIONS: PermissionDefinition[] = [
  { code: "warehouse.pick", label: "Сборка по заданиям", hint: "Своё задание: артикул, ячейка, количество, печать листа подбора, кнопки «собрано» и «не найден»." },
  { code: "warehouse.tasks", label: "Задания и отгрузки", hint: "Формировать задания по площадкам и складам, выдавать сборщикам, закрывать отгрузку вручную." },
